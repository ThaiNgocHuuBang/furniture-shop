                          ...
                          <?php
                            ...
                            ?> 
                             <tr>
                                ...
                                <td><a href="pending_furniture_pro.php"><button class="btn btn__color" style="font-size:12px">Verify order</button></td>
                             </tr>   
                           <?php 
                                  }
                                }
                          ...
                          <?php     
                            ...
                            ?> 
                             <tr>
                                 ...
                                 <td><a href="customers.php"><button class=" btn btn__color " style="font-size:12px">View Detail</button></td>
