<link rel="stylesheet" href="./css/access-detail.css">
<?php 
...
?>
   ...
   <div style="border-radius:0px" class="jumbotron bg-secondary " style="border-radius:0px">
      <h1 class="text-center text-white">Account Detail</h1>
    </div>
