<?php include('include/header.php'); ?>
        ...
        <div class="jumbotron">
            <h2 class="text-center mt-5 ">Edit Cart</h2>
        </div>
        ...
        if(isset($_SESSION['id'])){
          ...
          <div class="row">
            ...
            <div class="col-md-9 p-3">
                  <h5>Shopping Cart</h5>
                  <p class="text-right" style="margin-top:-30px"><a href="cart.php" class="text__yellow"><i class="fas fa-shopping-cart"></i> Go to Cart</a> </p>
                  <hr>
                  <form  method="post">
