...
//                     }
            ...
            <button type="submit" onclick="a()" name="submit" class="btn btn__update"><i
                        ...
                        <img src="img/<?php echo $img1; ?>" class="hover-effect" width="100%" height="190px">
                            <div class="text-center mt-3">
                             ...
                             <div class="row">
                                  ...
                                  <a href="product-detail.php?product_id=<?php echo $pid;?>" type="submit" onclick="a()" class="btn btn__card mr-2">
