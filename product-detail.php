...
<main>
  ...
  <div class="container">
    ...
    <section class="my-5">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <p><span class="mr-1 product__price"><strong><?php echo $price; ?></strong> $</span></p>
          <p class="pt-1 "><?php echo $detail; ?></p>
          <div class="table-responsive">
            <table class="table table-borderless mb-0 ">
              <tbody>
                <tr>
                  <th class="pl-0 w-25 product__size" scope="row">Size</th>
                  <td><?php echo $size; ?></td>
                </tr>
          ...
          <form method="post">
            ...
            <button type="submit" onclick="a()" name="submit" class="btn btn__or"><i class="fas fa-shopping-cart pr-2"></i> Add to cart</button>
    ...
    <section>
      ...
      <h3 class="text-center pt-5 mb-0 text-uppercase">Related Products </h3>
            ...
            <div class="col-md-6 col-lg-3 mb-4">
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-12 text-center">
                  ...
                  <a href="product-detail.php?product_id=<?php echo $pid; ?>" type="submit" onclick="a()" class="btn btn__white mr-2">
