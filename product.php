            ...
            <form method="post">
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <input class="btn btn__or rounded-left ml-2" type="submit" name="sear_submit" vlaue="Search">
                </div>
              </div>
            </form>
          </div>
              ...
              <div class="col-md-4 mt-4">
                ...
                <div class="row ">
                  <div class="col-md-12 col-sm-12 col-12 text-center mb-4">
                    ...
                    <a href="product.php?cart_id=<?php echo $pid; ?>" type="submit" onclick="a()" class="btn btn__white mr-2">
